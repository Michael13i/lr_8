...
public class Lr_8_test {
    ...
    // Перевіряє, чи сума від'ємних чисел у масиві {-3, -5, 0, -7} дорівнює -15
    // позитивний тест
    @Test
    public void testSumNegative() {
        int[] array = {-3, -5, 0, -7};
        assertEquals(-15, Lr_8.sumNegative(array));
    }

    // Перевіряє, чи метод коректно повертає 0 для порожнього масиву {}
    // Негативний тест
    @Test
    public void testSumNegativeWithEmptyArray() {
        int[] array = {};
        assertEquals(0, Lr_8.sumNegative(array));
    }
